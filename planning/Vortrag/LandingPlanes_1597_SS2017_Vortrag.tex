...
\begin{frame} {GeoTIFF}{Beispiel-Datensatz}
	...
	\note{
	\url{https://de.wikipedia.org/wiki/World_file}
	Ein World-File enthält 6 Zeilen mit den 6 Parametern der Affintransformation:		
	\begin{itemize}
			\item a11 = x-Komponente der Pixelbreite
			\item a21 = y-Komponente der Pixelbreite
			\item a12 = x-Komponente der Pixelhöhe
			\item a22 = y-Komponente der Pixelhöhe (meist negativ)
			\item b1 = x-Koordinate des obersten linken Bildpunkts (Zentrum des Bildpunkts)
			\item b2 = y-Koordinate des obersten linken Bildpunkts (Zentrum des Bildpunkts)
...
\begin{frame}{Programmiermodelle mit Threads}{}
...
\hline 
NO$\rightarrow$SW (45$^\circ$) & 704 & 1 & 1 & 18147 & 327 \\ 
\hline 
NO$\rightarrow$SW (45$^\circ$) & 704 & 64 & 1 & 18423 & 701 \\ 
\hline 
...
\hline 
NO$\rightarrow$SW (45$^\circ$) & 704 & 1 & 2 & 15208 & 216 \\ 
\hline 
NO$\rightarrow$SW (45$^\circ$) & 704 & 64 & 2 & 8976 & 327 \\ 
\hline
...
\hline 
NO$\rightarrow$SW (45$^\circ$) & 704 & 8 & 4 & 5406 & 442 \\ 
\hline
...
\begin{axis}[ 
  ...
  \addlegendentry{Ost-West}
    \addlegendentry{Nordwest-Südost}
  \end{axis} 
